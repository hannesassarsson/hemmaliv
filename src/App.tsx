...
import { Dumbbell, ListChecks, Moon, RefreshCw, ShoppingBasket, Sun, UtensilsCrossed } from "lucide-react";
...
type Tab = "handla" | "attgora" | "mat" | "traning";
const tabs = [
...
export default function App() {
  ...
  const [tab, setTab] = useState<Tab>("handla");
  ...
  return <div className="mx-auto flex min-h-screen w-full max-w-lg flex-col bg-background">
    ...
    <main className="flex-1 space-y-5 px-4 pb-28 pt-4">{tab === "handla" && <ShoppingList />}{tab === "attgora" && <><TodoLists /><NotificationsCard /></>}{tab === "mat" && <MealPlanner />}{tab === "traning" && <Training />}</main>
